...
[];for(var i=0;i<this._cols;++i){var j=e("<span>&nbsp;</span>").appendTo(f);this._matrix[c][i]=j}}this._pointer={x:0,y:0};this._table.appendTo(this._root);this._footer=e("<div/>").addClass("footer").appendTo(this._root);this._message=e("<div/>").addClass("message").append("<span/>").appendTo(this._root).find("span");this._lines=[""];this._page=this._offset=0;this._set_pointer(0,0);var d=this;this._focus=b.enabled;e(document).bind("keydown.micro",function(g){if(d.focus)if(g.which===37)d._pointer.x>
